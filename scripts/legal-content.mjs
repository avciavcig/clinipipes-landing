...
<p>Başvurunuzdan sonra 1 iş günü içinde hesabınız açılır. Portalda 5 adımlı kurulum sihirbazı sizi yönlendirir: klinik bilgileri ve görseller (logo, klinik/doktor/rehber fotoğrafları), çok dilli hasta formu (EN/TR/DE), ekip, bildirimler ve test. Zorunlu alanlar tamamlanmadan sonraki adıma geçilemez. Kurulum paketinde logo, rehber fotoğrafları ve ekip eğitimi dahildir.</p>
<hr>
